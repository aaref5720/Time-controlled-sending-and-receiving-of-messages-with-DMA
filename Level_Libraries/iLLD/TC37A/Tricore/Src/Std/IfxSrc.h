...
#include <Level_Libraries/iLLD/TC37A/Tricore/_Impl/IfxSrc_cfg.h>
#include <Level_Libraries/iLLD/TC37A/Tricore/Cpu/Std/IfxCpu_Intrinsics.h>
...
/** \brief Initializes an IVT entry with an ISR.
 *  \param srpn interrupt service priority number (index into IVT)
 *  \param isr function pointer to the ISR
 *  \note This prototype is provided by the application if the platform/libraries
 *        do not supply an implementation.
 */
