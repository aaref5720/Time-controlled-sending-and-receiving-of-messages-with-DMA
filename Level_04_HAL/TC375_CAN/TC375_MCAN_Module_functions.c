/**********************************************************************************************************************
 * \file TC375_MCAN_Module_functions.c
 ...
 *
 * Initialization of the MCAN0 Module.
 */

/*
 * status: V01.0 2025-12-13
 */
...
/*********************************************************************************************************************/
/*
 * function:    Func_MCAN0_Module_init
 * returns:     HAL_Return_Type Error report
 * parameters:  void
 * description: The function switches on the MCAN module of TC375.
 */
HAL_Return_Type Func_MCAN0_Module_init(void)
{
    HAL_Return_Type tmp_HAL = HAL_E_NOT_OK;
    uint32 tmp_uint32;

    /*
     * Initialization of the MCAN0 control register CLC to switch on clock
     *
    ...
    if(CAN0_CLC.B.DISR == 0x0)
    {
        if(CAN0_CLC.B.EDIS == 0x1)
        {
            tmp_HAL = HAL_E_OK;
        }
        else
